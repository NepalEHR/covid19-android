...
public class map_dialog extends Dialog implements LocationListener, OnMapReadyCallback {
    ...
    GoogleMap gMain;
    public map_dialog(Activity a, TextView ed_location,GoogleMap gMain) {
        super(a);
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null && updateFlag) {
            updateFlag = false;
            ed_location.setText(mCurrentLocation.getLongitude() + "," + mCurrentLocation.getLatitude());

            COVSettings.getInstance().setHomeLoc(mCurrentLocation.getLongitude() + "," + mCurrentLocation.getLatitude());
...
//                .position(new LatLng(OrderLatitude, OrderLongitude))
//                .title("Order Area"));

        LatLng madrid = new LatLng(OrderLongitude, OrderLatitude);
        googleMap.addMarker(new MarkerOptions().position(madrid).title(""));
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(OrderLatitude, OrderLongitude), 14));
        googleMap.setOnMarkerDragListener(new GoogleMap.OnMarkerDragListener() {
            ...
            public void onMarkerDragEnd(Marker arg0) {
                ...
                ed_location.setText(arg0.getPosition().longitude + "," + arg0.getPosition().latitude);
                COVSettings.getInstance().setHomeLoc(arg0.getPosition().longitude + "," + arg0.getPosition().latitude);

                LatLng madrid = new LatLng(arg0.getPosition().longitude , arg0.getPosition().latitude);
                gMain.addCircle(new CircleOptions()
                        .center(madrid)
                        .radius(100)
                        .strokeWidth(0f)
                        .fillColor(0x550000FF));
